...
import { startResponseMeasurement } from "./metrics.js";
import { Stats } from "./stats-view.js";
...
export function App() {
  ...
  const send = async (submittedPrompt = prompt) => {
    ...
    const measurement = startResponseMeasurement({ provider: configuration.provider, model: configuration.model });
