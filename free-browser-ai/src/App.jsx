...
function About() {
  return <section className="panel about_panel" aria-labelledby="about-title">
    <div className="about_copy">
      <h1 id="about-title">About</h1>
      <h2 className="tab_subheading">Local browser AI</h2>
      <p>Free Browser AI is a local chat workspace for small language models. It prepares models only when needed and keeps inference and conversation content on-device.</p>
      <div className="about_grid">
        <section aria-labelledby="about-runtimes"><h2 id="about-runtimes" className="about_heading">Runtimes</h2><ul className="about_list"><li><a href="https://huggingface.co/docs/transformers.js/">Transformers.js</a>: CPU/WASM with optional WebGPU.</li><li><a href="https://webllm.mlc.ai/">WebLLM</a>: WebGPU in supported browsers.</li></ul></section>
        <section aria-labelledby="about-benefits"><h2 id="about-benefits" className="about_heading">Benefits</h2><ul className="about_list"><li>Runs model inference locally.</li><li>Saves conversations and settings in this browser.</li></ul></section>
        <section aria-labelledby="about-drawbacks"><h2 id="about-drawbacks" className="about_heading">Drawbacks</h2><ul className="about_list"><li>Models download before first use.</li><li>WebLLM requires compatible WebGPU.</li></ul></section>
      </div>
    </div>
    <Stats embedded />
  </section>;
