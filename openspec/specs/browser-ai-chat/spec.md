...
- **THEN** every heading, configured Provider Model, Generation control, Persistence action, and conversation-setup control can be reached through one clear vertical scroll path
