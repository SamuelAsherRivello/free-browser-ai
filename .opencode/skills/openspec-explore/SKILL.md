...
The current change belongs to this OpenCode conversation, never a shared project file. Treat the session's most recently created or selected change as the current proposal during exploration unless the user explicitly names another.
